package com.arrowwould.collegeapp;
...
import com.arrowwould.collegeapp.authentication.LoginActivity;
import com.arrowwould.collegeapp.ebook.EbookActivity;
import com.arrowwould.collegeapp.youtube.YouTubeViewActivity;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.navigation_developer) {
            ...
            startActivity(new Intent(this, YouTubeViewActivity.class));
